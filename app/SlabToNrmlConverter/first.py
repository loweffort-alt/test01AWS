...
# Cargar el shapefile
shape_file_path = os.path.join("public",
                               "slab2.0 - subduction",
                               "sam_depth_5km.shp")
...
# Editable entre ["interfase | F-3a", "interfase | F-4a",
# "interfase | F-5a.1","intraplaca | F-3b", "intraplaca | F-3c",
# "intraplaca | F-4b","intraplaca | F-4c.1","intraplaca | F-4c.2",
# "intraplaca | F-5b.1","intraplaca | F-5c.1","corteza | PSw-3",
# "corteza | PSw-4","corteza | PSe-3","corteza | PSe-5","corteza | PSw-5",
# "corteza | PSe-4", "corteza | PSe-6"]

fuente = "interfase | F-3a"
...
# Aplanar en secuencia sin repetir nodos
puntos_oeste = [segmentos_oeste[0][0]] + [seg[1] for seg in segmentos_oeste]
...
if not segmentos_sur:
    raise ValueError("No se encontraron segmentos con seno y coseno positvos.")
...
# Aplanar en secuencia sin repetir nodos
puntos_norte = [segmentos_norte[0][0]] + [seg[1] for seg in segmentos_norte]
...
fig.write_html("fuente_sismica.html")
